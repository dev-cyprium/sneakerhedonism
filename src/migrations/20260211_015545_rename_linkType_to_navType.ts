...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_header_nav_items_nav_type" AS ENUM('link', 'category', 'categoryWithChildren');
  ...
  CREATE TABLE "header_nav_items" (
  	...
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"nav_type" "enum_header_nav_items_nav_type" DEFAULT 'link',
  ...
  ALTER TABLE "header_nav_items" ADD CONSTRAINT "header_nav_items_parent_category_id_categories_id_fk" FOREIGN KEY ("parent_category_id") REFERENCES "public"."categories"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "header_nav_items_parent_category_idx" ON "header_nav_items" USING btree ("parent_category_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE "public"."enum_header_nav_items_nav_type";
